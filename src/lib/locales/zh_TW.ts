...
const messages: Messages = {
  ...
  settingsBtn: '⚙ 設定',
  saveCurrentTabBtn: '收藏目前頁並智慧分類',
  setupTitle: '完成設定後即可開始使用',
  setupApiKeyDesc: '前往設定新增 AI 服務的 API Key，即可開始智慧收藏。',
  ...
  labelModel: '模型',
  refreshModelsTitle: '重新整理模型清單',
  modelsLoading: '正在取得模型…',
  modelsFetchError: '無法取得最新模型，已顯示內建清單',
